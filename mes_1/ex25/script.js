const usuarios = [
  { nome: "Anderson Silva", email: "anderson.silva1@gmail.com", idade: 22, ativo: true, cidade: "Luanda" },
...
const name = usuarios.map(nomes => nomes.nome)

const busca = usuarios.find(add => add.email == "anacleto.vasques100@gmail.com")

const city = usuarios.reduce(function(acomulador, valor){
